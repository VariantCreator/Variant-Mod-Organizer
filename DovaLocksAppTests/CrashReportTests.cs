...
static class CrashReportTests
{
 public static void Run(string root)
 {
  ...
  File.WriteAllText(log,"regular session\nlast entry");if(!UnrealCrashReport.Read(log).Details.Contains("No explicit crash marker"))throw new Exception("Normal log called a crash");
